...
[Dream App Welcome Server](1-5.md) || **Event-Driven Order Tracker** || [File Logger Module](1-5-3.md) || [MongoDB Power](#mongodb) || [YourDreamProject LIVE](#project)

#### Mini Project 2: "Event-Driven Order Tracker" (*Section: Event-driven, non-blocking I/O, and single-threaded model*)
