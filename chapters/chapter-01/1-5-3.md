...
5. Test the Server<br />
   ...
   ```css
	<span color='green'>Request</span> logged!
   ```
   - Additionally, check the log.txt file in the project directory. It should have logged entries with timestamps, similar to this:
   ```makefile
	2025-03-27T12:00:00.000Z - Visited http://localhost:3000
	2025-03-27T12:00:02.000Z - Order ready!
   ```
