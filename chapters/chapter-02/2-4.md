...
- [**`controllers/userController.js`**](#middleware/validateUser.js): Contains CRUD logic.
- [**`middleware/`**](#middleware/validateUser.js): Holds validation and existence check middleware.
