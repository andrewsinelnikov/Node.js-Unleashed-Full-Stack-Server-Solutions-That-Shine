...
In `routes`, route files use `express.Router()`, controllers hold logic, middleware holds functions like `authMiddleware`, and `app.js` brings it all together.
