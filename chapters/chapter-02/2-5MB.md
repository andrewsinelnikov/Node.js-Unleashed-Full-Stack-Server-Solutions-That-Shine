...
2. 📦 Morgan Middleware<br />
   **What does the Morgan middleware do, and what does the 'dev' format provide in your console output?**<br />
   *(Hint: It logs HTTP requests, and 'dev' shows a concise, color-coded summary!)*
